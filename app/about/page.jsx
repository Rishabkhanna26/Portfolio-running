      ...
      <section className="px-4 pb-16 sm:px-6 sm:pb-20">
        <div className="mx-auto max-w-4xl rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            <Link href="/services/whatsapp-automation" className="flex min-h-12 w-full items-center rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-base font-medium leading-6 text-slate-200 transition-colors hover:border-slate-500 hover:text-white">
              WhatsApp Automation Service
            </Link>
            <Link href="/services/ai-chatbots" className="flex min-h-12 w-full items-center rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-base font-medium leading-6 text-slate-200 transition-colors hover:border-slate-500 hover:text-white">
              AI Chatbot Service
            </Link>
            <Link href="/services/lead-generation" className="flex min-h-12 w-full items-center rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-base font-medium leading-6 text-slate-200 transition-colors hover:border-slate-500 hover:text-white">
              Lead Generation Service
            </Link>
            <Link href="/contact" className="flex min-h-12 w-full items-center rounded-xl border border-slate-700 bg-slate-950/60 px-4 py-3 text-base font-medium leading-6 text-slate-200 transition-colors hover:border-slate-500 hover:text-white">
              Contact Page
            </Link>
          </div>
        </div>
