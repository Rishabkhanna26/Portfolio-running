    ...
    <MarketingShell>
      ...
      <section className="px-4 pb-14 sm:px-6 sm:pb-20">
        <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-2">
          <article className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
            <h2 className="text-xl xxs:text-lg font-semibold text-white">What it solves</h2>
          ...
          <article className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
            <h2 className="text-xl xxs:text-lg font-semibold text-white">Best fit</h2>
            <p className="mt-3 break-words text-base xxs:text-sm leading-7 text-slate-300">
      ...
      <section className="px-4 pb-14 sm:px-6 sm:pb-20">
        <div className="mx-auto max-w-5xl rounded-2xl border border-slate-800 bg-slate-900/70 p-6 sm:p-8">
          <h2 className="text-2xl xxs:text-xl font-semibold text-white">Core Features</h2>
